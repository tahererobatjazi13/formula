...
import ir.kitgroup.formulaNew.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var todayDateBkp: String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        todayDateBkp = "${jalaliDate.year.toString().takeLast(2)}_${jalaliDate.month}_${jalaliDate.day}"
    ...
    private fun backupDatabaseAsZip(context: Context): File? {
        return try {
            ...
            val formattedDate = "$todayDateBkp _ $time"

            val zipFileName = "bkp_$formattedDate.zip"
