...
import ir.kitgroup.formulaNew.adapter.ProductDetailAdapter
import ir.kitgroup.formulaNew.core.Util
import ir.kitgroup.formulaNew.database.entity.ProductDetail
import ir.kitgroup.formulaNew.databinding.FragmentProductDetailsBinding
...
class ProductDetailsFragment : Fragment() {
    ...
    private fun updateTotalUI(
        ...
        productDetailAdapter.setTotalQuantity(totalQuantity)
    }
    ...
    private fun generatePdfWithData(
        ...
        try {
            ...
            val columnWidths = floatArrayOf(3f, 3f, 1.5f, 1.5f, 3f)
            ...
            table.addCell(
                createCell(
                    context.getString(R.string.label_percentage),
                    farsiFont,
                    headerColorBase
                )
            )
            ...
            for (i in items.indices) {
                ...
                val percent = (item.quantity / totalQuantity) * 100
                ...
                val cellPercent = createCell(
                    formattedPercent, farsiFont, rowColor
                )
            ...
            table.addCell(
                createCell(
                    "100", farsiFontBold14, footerColorBase
                )
            )
